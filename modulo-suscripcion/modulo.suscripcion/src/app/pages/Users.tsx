...
export function Users() {
  const users = [
    { id: 1, name: "Ana Martínez", email: "ana.martinez@ejemplo.com", role: "Admin", status: "Activo" },
    { id: 2, name: "Carlos López", email: "carlos.lopez@ejemplo.com", role: "Usuario", status: "Activo" },
    { id: 3, name: "Laura Sánchez", email: "laura.sanchez@ejemplo.com", role: "Editor", status: "Inactivo" },
    { id: 4, name: "Miguel Ruiz", email: "miguel.ruiz@ejemplo.com", role: "Usuario", status: "Activo" },
    { id: 5, name: "Sofía Gómez", email: "sofia.gomez@ejemplo.com", role: "Usuario", status: "Pendiente" },
  ];
