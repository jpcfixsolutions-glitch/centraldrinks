...
export function AgregarProductoMesaModal({ isOpen, onClose, onAgregar, productos = [] }) {
            ...
            >
              ...
              <div className="flex items-center gap-4">
                ...
                <button
                  ...
                  className="bg-red-600 hover:bg-red-700 transition-colors rounded-lg px-4 py-2 flex items-center gap-2 disabled:opacity-50"
